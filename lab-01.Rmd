...
_Which attraction had the most number of visitors in 2022? The Crown Estate, Windsor Great Park
...
_What are the top 10 most visited attractions in 2021? The Crown Estate, Royal Botanic Gardens Kew, Natural History Museum, RHS Garden Wisley, The British Museum, Tate Modern, Somerset House, Science Museum, Jeskyns Community Woodland, V&A South Kensington
```{r Ex_c}
visitors %>% 
  arrange(desc(n_2021)) %>%
  head(n = 10)
...
_What is the admission charge for the `"National Museum of Scotland"`? Free
...
_Which attraction had exactly 565,772 visitors in 2022? Knowsley Safari and Knowsley Hall
...
_How many attraction had more than 1 million visitors in 2022? 22
...
_How many `"O"`utside attractions are there in the `"Yorkshire and the Humber"` region that gives `"Members"` free admission, which had more than 100,000 visitors in 2022? 3
...
_How many attractions had between 50,000 and 100,000 visitors in 2022? 50
...
_How many regions have more than 50 tourist attraction in the data set? (Hint: You will need to tabulate the data before filtering.) 1 (Scotland)
...
_What are the mean and median visitor numbers in 2022 across all attractions? Mean is 351,942 and median is 184640
...
_What does `NA` stand for and why are you getting this as your answer to the previous question. Not Applicable

Not Applicable as some of the attractions have no data available for this heading.
